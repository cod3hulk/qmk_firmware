...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_60_ansi(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, HYPR(KC_E), RGB_HUD, HYPR(KC_T), RGB_SAD, RGB_VAI, HYPR(KC_I), KC_TRNS, KC_MPLY, KC_MRWD, KC_MFFD, KC_TRNS, 
    KC_TRNS, KC_TRNS, HYPR(KC_S), HYPR(KC_D), KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_VOLD, KC_VOLU, KC_TRNS, 
    KC_TRNS, KC_TRNS, KC_TRNS, HYPR(KC_C), LCTL(LGUI(KC_V)), HYPR(KC_B), KC_TRNS, HYPR(KC_M), KC_MUTE, KC_TRNS, KC_TRNS, KC_TRNS,
